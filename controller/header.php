...
<head>
    ...
    <meta name="description" content="The Life We Deserve Foundation is a youth-led non-profit, civil society organization, founded on the principles of compassion, empathy, and social responsibility, we are committed to improving the well-being of those who need it the most.">
...
<header id="topnav" class="defaultscroll sticky">
    ...
    <a class="logo" href="/ngo_web/index">
        ...
        <ul class="buy-button list-inline mb-0">
            ...
            <li class="list-inline-item"><a class="btn btn-sm btn-primary" href="/donate">Donate Us</a></li>
        </ul>
