...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($blogID > 0 && !empty($name) && !empty($email) && !empty($message)) {
        ...
        $query = "INSERT INTO blog_comments (blog_id, commentor_name, commentor_email, commentor_post, comments_date) 
                  VALUES (?, ?, ?, ?, NOW())";
        ...
        // Bind parameters
        $stmt->bind_param("isss", $blogID, $name, $email, $message);
