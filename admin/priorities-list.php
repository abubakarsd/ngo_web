            ...
            <div class="col-lg-12">
                <div class="card product_item_list">
                    <div class="body table-responsive">
                        <div class="header">
                            <a href="create-priority.php" class="btn btn-primary">Creat New</a>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        function load_priority(){
            $.ajax({
                type: "POST",
                url: "includes/load_priority_list.php",
            ...
            $(document).on('click', '.btn_edit_priorities', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "includes/edit_priority.php",
                    dataType: 'json',
            ...
            $(document).on('submit', '#priority_form', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "includes/update_priority_list.php", // Update URL
                    data: formData,
                    dataType: 'json',
                    contentType: false,
                    processData: false,
