        ...
        <ul class="list">
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-label col-red"></i><span>Priorities</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="priorities-info.php">Priorities Info</a> </li>
                </ul>
            </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="index.php"><i class="zmdi zmdi-home"></i> Priorities</a></li>
                    <li class="breadcrumb-item active">Priority List</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="card product_item_list">
                    <div class="body table-responsive">
                        <div class="header">
                            <a href="create-priority-details.php" class="btn btn-primary">Creat New</a>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="largeModalLabel">Edit Priority</h4>
            </div>
            ...
            <form action="#" id="priority_form" enctype="multipart/form-data">
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="form-line">
                                <textarea id="myTextarea" name="short_text" class="form-control no-resize" placeholder="Please type what you want..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function load_priority(){
            $.ajax({
                type: "POST",
                url: "includes/load_priority_info_list.php",
                success: function (result) {
                    $("#load_priority_list").html(result);
                }
            });
            }
            // largeModal
            ...
            $(document).on('click', '.btn_edit_priorities', function (e) {
                e.preventDefault();
                var priorityid = $(this).attr('id');
                $.ajax({
                    type: "POST",
                    url: "includes/edit_priority_info.php",
                    dataType: 'json',
                    data: {priorityid: priorityid},
                    success: function (result) {
                        $("#priority_id").val(priorityid);
                        // $("#prio_image").val(result.page_img);
                        tinymce.get('myTextarea').setContent(result.page_discription);
                        // $("#myTextarea").val(result.page_discription);
      ...
      // delete button action
            $(document).on('click', '.btn_delete_priorities', function (e) {
                e.preventDefault();
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "includes/delete_priorities.php",
                        dataType: 'json',
                        data: {priorityid: priorityid},
                        success: function (result) {
