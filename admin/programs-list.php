        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="blog-dashboard.html">Programs</a></li>
            ...
            <div class="col-lg-12">
                <div class="card product_item_list">
                    <div class="body table-responsive">
                        <div class="header">
                            <a href="create-programs.php" class="btn btn-primary">Creat New</a>
                        </div>
                        <table class="table table-hover m-b-0 footable footable-1 footable-paging footable-paging-center breakpoint-lg" style="">
                            <thead>
                                <tr class="footable-header">
                                    ...
                                    <th class="footable-sortable" style="display: table-cell;">Program Title<span class="fooicon fooicon-sort"></span></th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="largeModalLabel">Edit Program</h4>
            </div>
            ...
            <form action="#" id="program_form" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="prog_location" name="prog_location" placeholder="Pleaseinsert program location">
                </div>
                <div class="form-group">
                    <input type="date" class="form-control" id="program_date" name="program_date" placeholder="Enter Date">
                </div>
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="form-group">
...
fetch_users_info();
        ...
        // load donation list
        load_program_list();
        function load_program_list(){
            $.ajax({
                type: "POST",
                url: "includes/load_program_list.php",
                success: function (result) {
                    $("#load_program_list").html(result);
                }
            });
            }
            ...
            // largeModal
            $(document).on('click', '.btn_edit_program', function (e) {
                    e.preventDefault();
                    var programid = $(this).attr('id');
                    $.ajax({
                        type: "POST",
                        url: "includes/edit_program_post.php",
                        dataType: 'json',
                        data: {programid: programid},
                        success: function (result) {
                            $("#program_id").val(programid);
                            $("#program_title").val(result.programtitle);
                            $("#prog_location").val(result.proglocation);
                            $("#program_date").val(result.progdate);
                            // Set content inside the rich text editor using TinyMCE API
                            tinymce.get('myTextarea').setContent(result.progdiscription);
      ...
      // delete button action
            $(document).on('click', '.btn_delete_program', function (e) {
                e.preventDefault();
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "includes/delete_program_post.php",
                        dataType: 'json',
                        data: {programid: programid},
                        success: function (result) {
            ...
            $(document).on('submit', '#program_form', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "includes/update_posts_program.php",
