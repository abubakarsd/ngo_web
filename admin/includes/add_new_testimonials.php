...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error)) {
        ...
        $stmt = $con->prepare("INSERT INTO testimonials 
                                    (title, text, name, role, image, rating)
                                    VALUES (:testimonial_title, :testimonial_details, 
                                    :testimonial_name, :testimonial_role, :testimonial_img, 
                                    :testimonial_rating)");
