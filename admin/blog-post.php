...
<aside id="leftsidebar" class="sidebar"> 
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"> <a href="blog-post.php"><i class="zmdi zmdi-picture-in-picture"></i><span>Post New Blog</span> </a> </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                    <form class="form-horizontal" action="#" id="form_post_blog" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-default btn-round waves-effect">Post Blog</button>
                    </form>                     
                </div>
                </div>
            </div>            
...
$(document).on('submit', '#form_post_blog', function (e) {
                e.preventDefault();
                ...
                formDataWithFiles.append('blog_title', $('#blog_title').val());
                formDataWithFiles.append('author', $('#author').val());
                formDataWithFiles.append('donation_description', description);
                
                // Send the AJAX request
                $.ajax({
                    type: "POST",
                    url: "includes/post_blog_news.php",
