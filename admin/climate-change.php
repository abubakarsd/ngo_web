    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Climate Change Detail
                    <small>Welcome to Climate Change Detail</small>
                </h2>
            </div>
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="index.php"><i class="zmdi zmdi-home"></i> Home</a></li>
                    <li class="breadcrumb-item"><a href="blog-dashboard.html">Climate Change</a></li>
...
var myDropzone = new Dropzone("#frmFileUpload", {
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url: "includes/fetch_initiative_climate.php",
            method: "GET",
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "includes/fetch_climate_info.php",
                dataType: 'json',
        ...
        $(document).on('submit', '#initiative_form', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "includes/update_climate.php",
